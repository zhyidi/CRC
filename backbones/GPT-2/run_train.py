...
def train():
    ...
    tokenizer = BertTokenizer.from_pretrained(args.model_checkpoint) #"uer/gpt2-chinese-cluecorpussmall"
    model = GPT2LMHeadModel.from_pretrained(args.model_checkpoint) #"uer/gpt2-chinese-cluecorpussmall"
